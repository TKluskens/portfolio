    ...
    <footer className="py-8 bg-gray-900 text-white text-center">
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center space-x-6 mt-4">
          <a href="https://github.com/TomKluskens2004/portfolio.git" className="hover:text-blue-400">
            <FaGithub size={24} />
          </a>
          ...
          <a href="mailto:kluskenstom2004@gmail.com" className="hover:text-blue-400">
            <FaEnvelope size={24} />
          </a>
        </div>
      </div>
